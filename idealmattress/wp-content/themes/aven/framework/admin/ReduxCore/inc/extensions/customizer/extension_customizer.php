        ...
        class ReduxFramework_extension_customizer {
            ...
            public function __construct( $parent ) {
                ...
                if ( empty( $this->_extension_dir ) ) {
                    $this->_extension_dir = trailingslashit( str_replace( '\\', '/', ZOZO_REDUX . '/inc/extensions/customizer' ) );
            ...
            public function _register_customizer_controls( $wp_customize ) {
                ...
                if ( ! class_exists( 'Redux_Customizer_Section' ) ) {
                    require_once ZOZO_REDUX . '/inc/extensions/customizer' . '/inc/customizer_section.php';
                    if ( method_exists( $wp_customize, 'register_section_type' ) ) {
                        $wp_customize->register_section_type( 'Redux_Customizer_Section' );
                    }
                }
                if ( ! class_exists( 'Redux_Customizer_Panel' ) ) {
                    require_once ZOZO_REDUX . '/inc/extensions/customizer' . '/inc/customizer_panel.php';
                ...
                if ( ! class_exists( 'Redux_Customizer_Control' ) ) {
                    require_once ZOZO_REDUX . '/inc/extensions/customizer' . '/inc/customizer_control.php';
                }

                require_once ZOZO_REDUX . '/inc/extensions/customizer' . '/inc/customizer_fields.php';
                require_once ZOZO_REDUX . '/inc/extensions/customizer' . '/inc/customizer_devs.php';
            ...
            public function _enqueue_previewer() {
                ...
                $localize = array(
                    'save_pending'   => __( 'You have changes that are not saved. Would you like to save them now?', 'aven' ),
                    'reset_confirm'  => __( 'Are you sure? Resetting will lose all custom values.', 'aven' ),
                    'preset_confirm' => __( 'Your current options will be replaced with the values of this preset. Would you like to proceed?', 'aven' ),
