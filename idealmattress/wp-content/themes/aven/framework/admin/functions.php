...
function aven_zozo_admin_icon_styles_compatible() {
	// CSS		
	wp_enqueue_style( 'aven-zozo-font-awesome', ZOZOTHEME_URL . '/css/font-awesome.css', false, '4.6.3', 'all' );
	wp_enqueue_style( 'aven-zozo-iconspack', ZOZOTHEME_URL . '/css/iconspack.css', false, '1.0', 'all' );
}
