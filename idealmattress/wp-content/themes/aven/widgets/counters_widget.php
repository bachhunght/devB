<?php
class Aven_Zozo_Counters_Widget extends WP_Widget {
	...
	function widget($args, $instance)
	{
		...
		$counter_label_1 = !empty($instance['counter_label_1']) ? $instance['counter_label_1'] : esc_html__('Total Downloads : ', 'aven' );
		$counter_value_1 = $instance['counter_value_1'];
		$counter_label_2 = !empty($instance['counter_label_2']) ? $instance['counter_label_2'] : esc_html__('Happy Clients : ', 'aven' );
	...
	function form($instance)
	{
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id('counter_label_1') ); ?>"><?php _e('Counter Label 1:', 'aven'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id('counter_value_1') ); ?>"><?php _e('Counter Value 1:', 'aven'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id('counter_label_2') ); ?>"><?php _e('Counter Label 2:', 'aven'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id('counter_value_2') ); ?>"><?php _e('Counter Value 2:', 'aven'); ?></label>
...
function aven_zozo_counters_load()
{
	register_widget('Aven_Zozo_Counters_Widget');
}

add_action('widgets_init', 'aven_zozo_counters_load');
?>