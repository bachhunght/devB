<?php
class Aven_Zozo_Category_Posts_Widget extends WP_Widget {
...
function aven_zozo_category_posts_load()
{
	register_widget('Aven_Zozo_Category_Posts_Widget');
}

add_action('widgets_init', 'aven_zozo_category_posts_load');
