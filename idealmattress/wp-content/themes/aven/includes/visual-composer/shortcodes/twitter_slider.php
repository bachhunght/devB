...
if ( ! function_exists( 'aven_zozo_vc_twitter_slider_shortcode' ) ) {
	function aven_zozo_vc_twitter_slider_shortcode( $atts, $content = NULL ) {
		...
		if( $screen_name && $consumer_key && $consumer_secret && $access_token && $access_token_secret && $twitter_count ) {
            ...
            $output .= '<p>' . esc_html__('Please configure twitter options.', 'aven') . '</p>';
        }
...
if ( ! function_exists( 'aven_zozo_vc_twitter_slider_shortcode_map' ) ) {
	function aven_zozo_vc_twitter_slider_shortcode_map() {
		
		vc_map( 
			array(
				"name"					=> esc_html__( "Twitter Slider", "aven" ),
				"description"			=> esc_html__( "Show your twitter feeds in Slider.", 'aven' ),
				...
				"params"				=> array(
					...
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Consumer Key", "aven" ),
						"param_name"	=> "consumer_key",
						"value" 		=> "",
					),
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Consumer Secret", "aven" ),
						"param_name"	=> "consumer_secret",
						"value" 		=> "",
					),
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Access Token", "aven" ),
						"param_name"	=> "access_token",
						"value" 		=> "",
					),
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Access Token Secret", "aven" ),
						"param_name"	=> "access_token_secret",
						"value" 		=> "",
					),
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Twitter Screen Name", "aven" ),
					...
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Number of Tweets", "aven" ),
						'admin_label'	=> true,
...
add_action( 'vc_before_init', 'aven_zozo_vc_twitter_slider_shortcode_map' );