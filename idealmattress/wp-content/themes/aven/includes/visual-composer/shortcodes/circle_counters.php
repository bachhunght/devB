...
if ( ! function_exists( 'aven_zozo_vc_circle_counter_shortcode' ) ) {
	function aven_zozo_vc_circle_counter_shortcode( $atts, $content = NULL ) {
...
if ( ! function_exists( 'aven_zozo_vc_circle_counters_shortcode_map' ) ) {
	function aven_zozo_vc_circle_counters_shortcode_map() {
		
		vc_map( 
			array(
				"name"					=> esc_html__( "Pie Chart", "aven" ),
				"description"			=> esc_html__( "Animated Circle Pie Chart with Counters.", 'aven' ),
				...
				"params"				=> array(
					array(
						...
						"param_name"	=> "columns",
						"value"			=> array(
							esc_html__( "3 Columns", "aven" )	=> "3",
							esc_html__( "4 Columns", "aven" )	=> "4",
							esc_html__( "5 Columns", "aven" )	=> "5" ),
					),
					array(
						'type'			=> 'textfield',
						'heading'		=> esc_html__( 'Circle Size', "aven" ),
						'param_name'	=> 'circle_size',
						'value' 		=> '',
					),
					array(
						'type'			=> 'textfield',
						'heading'		=> esc_html__( 'Circle Line Width', "aven" ),
					...
					array(
						...
						"heading"		=> esc_html__( "Graphic Values", "aven" ),
						"param_name"	=> "counter_value",
						"value" 		=> '90|Development,80|Design,70|Marketing',
						"description" 	=> esc_html__( "Input graph values, titles, description and bar color, track color here. Divide values with linebreaks (Enter). Example: 90|Development|Your Description|#0099cc|#ffffff", "aven" ),
						"group"			=> esc_html__( "Pie Chart", "aven" ),
					),
					array(
						"type"			=> 'colorpicker',
					...
					array(
						"type"			=> 'colorpicker',
						"heading"		=> esc_html__( "Description Color", "aven" ),
...
add_action( 'vc_before_init', 'aven_zozo_vc_circle_counters_shortcode_map' );