	...
	<?php do_action('epl_property_before_content'); ?>
						...
						<div class="epl-blog-image">
							...
							<div class="epl-stickers-wrapper">
								...
								<div class="epl-featured-sticker">
									<h6><span class="status-sticker featured"><?php esc_html_e('Featured', 'aven'); ?></span></h6>
								</div>
								<?php } ?>
							</div>
							<?php } ?>
							<?php the_post_thumbnail( 'aven-portfolio-mid' , array( 'class' => $image_class ) ); ?>
							<!-- Price -->
							<div class="price">
		...
		<div class="property-box property-box-right property-content">
			...
			<div class="entry-content epl-list-view-content">
				<p><?php echo aven_zozo_shortcode_stripped_excerpt( get_the_content(), 40 ); ?></p>
			</div>
			<!-- Property Featured Icons -->
			<div class="property-feature-icons">
				<?php do_action('aven_zozo_epl_loop_property_icons'); ?>
			</div>
		</div>
