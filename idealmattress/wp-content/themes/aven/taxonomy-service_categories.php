			...
			<div class="zozo-row row">	
				<div id="primary" class="content-area <?php aven_zozo_primary_content_classes(); ?>">
					<div id="content" class="site-content">
						...
						if( aven_zozo_get_theme_option( 'zozo_service_archive_count' ) != '' ) {
							$posts = aven_zozo_get_theme_option( 'zozo_service_archive_count' );
						} else {
							$posts = 10;
						}						
						
						if( aven_zozo_get_theme_option( 'zozo_service_archive_columns' ) != '' ) {
							$grid_columns = aven_zozo_get_theme_option( 'zozo_service_archive_columns' );
						} else {
							$grid_columns = 4;
						}
						...
						if( $query->have_posts() ):
									...
									<div id="services-<?php the_ID(); ?>" <?php post_class('services-item'); ?>>
										...
										<div class="services-content-wrapper">
											...
											echo '<div class="services-excerpts"><p>';
												echo aven_zozo_shortcode_stripped_excerpt( get_the_excerpt(), 10 );
											echo '</p></div>';
							...
							echo '</div>';
							echo aven_zozo_pagination( $query->max_num_pages, '' );
