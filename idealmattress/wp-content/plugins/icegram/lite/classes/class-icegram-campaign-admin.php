...
if ( ! class_exists( 'Icegram_Campaign_Admin' ) ) {
	class Icegram_Campaign_Admin {
		...
		public function __construct() {
			...
			add_action( 'edit_form_advanced', array( &$this, 'add_campaign_ctas' ) );
	...
	Icegram::gallery_screen();
		...
		public function add_campaign_ctas(){
			global $post;

			if( $post->post_type != 'ig_campaign' ) return;
			
			$campaign_ctas = '<div style="float:right;position:relative;top:-0.5rem" class="campaign_ctas">';
