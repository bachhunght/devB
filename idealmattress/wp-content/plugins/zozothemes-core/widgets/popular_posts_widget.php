<?php
class Aven_Zozo_Popular_Posts_Widget extends WP_Widget {
				...
				<?php while( $popular_posts->have_posts( )): $popular_posts->the_post();
					...
					<li class="posts-item clearfix">
						...
						<div class="latest-post-content">
							...
							<?php } ?>
							<?php if( $show_date == 'on' ) { ?>
								<div class="entry-date posted-date"><i class="simple-icon icon-calendar"></i> <?php the_time( aven_zozo_get_theme_option( 'zozo_blog_date_format' ) ); ?></div>
							<?php } ?>
						</div>
					</li>
	...
	function form($instance)
	{
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id('categories') ); ?>"><?php _e('Choose Category:', 'aven'); ?></label>			
			<?php $args = array(
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id('posts_count') ); ?>"><?php _e('Number of posts to show:', 'aven'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('show_date') ); ?>"><?php _e('Show Date', 'aven'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('show_excerpt') ); ?>"><?php _e('Show Excerpt', 'aven'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('show_thumb') ); ?>"><?php _e('Show Thumbnail Image', 'aven'); ?></label>
		</p>	
			
	<?php }
}

function aven_zozo_popular_posts_load()
{
	register_widget('Aven_Zozo_Popular_Posts_Widget');
}

add_action('widgets_init', 'aven_zozo_popular_posts_load');