<?php
class Aven_Zozo_Facebook_Like_Widget extends WP_Widget {
  ...
  ";
		...
		echo wp_kses( $after_widget, aven_zozo_expanded_allowed_tags() );
	}
	...
	function form($instance)
	{
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id('page_url') ); ?>"><?php _e('Facebook Page URL:', 'aven'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id('width') ); ?>"><?php _e('Width:', 'aven'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id('height') ); ?>"><?php _e('Height:', 'aven'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('show_stream') ); ?>"><?php _e('Show Stream', 'aven'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('show_faces') ); ?>"><?php _e('Show Faces', 'aven'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('show_header') ); ?>"><?php _e('Show Header', 'aven'); ?></label>
		</p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id('color_scheme') ); ?>"><?php _e('Color Scheme:', 'aven'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id('background') ); ?>"><?php _e('Background Color:', 'aven'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id('border_size') ); ?>"><?php _e('Border Size:', 'aven'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id('border_radius') ); ?>"><?php _e('Border Radius:', 'aven'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id('border_color') ); ?>"><?php _e('Border Color:', 'aven'); ?></label>
...
function aven_zozo_load_color_picker_script()
{
	wp_enqueue_script( 'wp-color-picker' );
}
function aven_zozo_load_color_picker_style()
{
	wp_enqueue_style( 'wp-color-picker' );
}
function aven_zozo_facebook_like_widget_load()
{
	register_widget('Aven_Zozo_Facebook_Like_Widget');
}

add_action('admin_print_scripts-widgets.php', 'aven_zozo_load_color_picker_script');
add_action('admin_print_styles-widgets.php', 'aven_zozo_load_color_picker_style');
add_action('widgets_init', 'aven_zozo_facebook_like_widget_load');
?>