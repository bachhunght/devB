        ...
        <?php endif; ?>
                ...
                <div id="content" class="site-content" role="main">
                   	...
                   	<?php if ( have_posts() ) : ?>
						...
						<!--masonry style-->
						<?php if ( GBT_MT_Opt::getOption( 'sidebar_blog_listing' ) == "2" ) : ?>
													...
													<div class="blog-post-inner">
														...
														<div class="entry-content-archive">
															...
															<?php if (get_option('rss_use_excerpt') == 0) : ?>
																<?php the_content(esc_html__('Continue Reading', 'mr_tailor')); ?>
															<?php elseif (get_option('rss_use_excerpt') == 1) : ?>
																<?php echo the_excerpt(); ?>
																<a href="<?php the_permalink(); ?>" class="more-link">
																	<?php esc_html_e('Continue Reading', 'mr_tailor'); ?>
																</a>
															<?php else :
																$excerpt = get_the_excerpt();
																echo substr( $excerpt , 0, 500);
											                    ?>
											                    <a href="<?php the_permalink(); ?>" class="more-link"><?php esc_html_e('Continue reading', 'mr_tailor'); ?></a>
															<?php endif ?>
