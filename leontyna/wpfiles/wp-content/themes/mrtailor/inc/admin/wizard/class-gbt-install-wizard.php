	...
	class GBT_InstallWizard {
		...
		public function setup_wizard_steps() {
			...
			<div class="gbt-wizard-logo <?php echo GBTHELPERS::theme_slug(); ?>">
				<a href="#">
					<img src="<?php echo get_template_directory_uri() .'/inc/admin/wizard/images/mrtailor-logo.png'; ?>" <?php echo file_exists(get_template_directory() .'/inc/admin/wizard/images/mrtailor-logo@2x.png')? 'srcset="'.get_template_directory_uri() .'/inc/admin/wizard/images/mrtailor-logo@2x.png 2x'.'"': '' ; ?> alt="Logo">
				</a>
			</div>
		...
		public function gbt_setup_introduction() {
			?>
				<div class="wrapper wizard-introduction" style="background-image:url(<?php echo get_template_directory_uri() .'/inc/admin/wizard/images/mr-tailor-prev.jpg'; ?>);">
					<div class="center">
						<h1><?php esc_html_e( GBTHELPERS::theme_name() . '\'s', 'mr_tailor');?> <br/> <?php esc_html_e('Theme Setup Wizard', 'mr_tailor' ); ?></h1>
		...
		public function gbt_setup_demo() {
			...
			<div class="wrapper wizard-demo-import">
				...
				<div class="demo-icon <?php echo ( ! $is_required_plugins === true) ? 'error' : '' ?>">
					...
					<?php else : ?>
						<p class="error-info"><?php printf(esc_html__( 'Please make sure %s and %s are installed and activated before importing the demo content.', 'mr_tailor' ), '<b>Visual Composer</b>', '<b>WooCommerce</b>') ; ?></p>
					<?php endif; ?>
				</div>
		...
		public function gbt_setup_final() {
			...
			<div class="wrapper wizard-ready">
				<div class="content-done" style="background-image:url(<?php echo get_template_directory_uri() .'/inc/admin/wizard/images/mr-tailor-prev.jpg'; ?>);">
					<div class="center">
						<h1><?php printf(esc_html__( 'Setup has been %s completed successfully!', 'mr_tailor' ), '<br/>'); ?></h1>
						<a href="<?php echo esc_url( site_url() ); ?>" class="button button-primary"><?php esc_html_e( 'View Site', 'mr_tailor' );?></a>
				...
				<div class="further-info">
					...
					<div class="column last">
						<ul>
							...
							<li><a href="<?php echo esc_url( GBTHELPERS::support_link() ); ?>" target="_blank"><span class="dashicons dashicons-editor-help"></span><?php esc_html_e( 'Help Center / Support', 'mr_tailor' ); ?></a></li>
						</ul>
					</div>
				</div>
		...
		public function _get_plugins() {
			...
			$newplugins['mr-tailor-portfolio'] = $plugins['mr-tailor-portfolio'];
