...
if (class_exists('YITH_WCWL')) : 
	if ( GBT_MT_Opt::getOption( 'main_header_wishlist' ) ) : 
...
if (class_exists('WooCommerce')) : 
	if ( GBT_MT_Opt::getOption( 'main_header_shopping_bag' ) ) : 
...
<header id="masthead" class="site-header header-centered<?php echo esc_attr($header_class); ?>" role="banner">
