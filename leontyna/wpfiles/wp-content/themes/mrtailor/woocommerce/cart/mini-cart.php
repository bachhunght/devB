...
if( class_exists('WC_Gateway_PPEC_Cart_Handler') ) {
	add_action( 'woocommerce_paypal_button', array( new WC_Gateway_PPEC_Cart_Handler(), 'display_mini_paypal_button' ), 10 );
}
...
<?php do_action( 'woocommerce_before_mini_cart' ); ?>
	...
	<?php if ( ! WC()->cart->is_empty() ) : ?>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="cart_list product_list_widget <?php echo esc_attr($args['list_class']); ?>">
...
<?php if ( ! WC()->cart->is_empty() ) : ?>
	...
	<p class="buttons">
		...
		<?php do_action( 'woocommerce_paypal_button' ); ?>
	</p>
