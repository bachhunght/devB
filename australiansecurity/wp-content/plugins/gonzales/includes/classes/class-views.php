...
class WGZ_Views {
	 ...
	 * @param WBCR\FactoryTemplates_204e5d1397aaf784fcbb05c582936ff1_107\Pages\PageBase $page
	 *
	 * @return bool|string       The page contents. False if the template doesn't exist.
	 */
	public function get_template( $template, $data = [], WBCR\FactoryTemplates_204e5d1397aaf784fcbb05c582936ff1_107\Pages\PageBase $page = null ) {
	 ...
	 * @param WBCR\FactoryTemplates_204e5d1397aaf784fcbb05c582936ff1_107\Pages\PageBase $page
	 */
	public function print_template( $template, $data = [], WBCR\FactoryTemplates_204e5d1397aaf784fcbb05c582936ff1_107\Pages\PageBase $page = null ) {
