<?php
	...
	if( !class_exists('Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_DatepickerRangeControl') ) {

		class Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_DatepickerRangeControl extends Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->range_1 = new Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_TextboxControl($options['range_1'], $form, $provider);
				$this->range_2 = new Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_TextboxControl($options['range_2'], $form, $provider);
