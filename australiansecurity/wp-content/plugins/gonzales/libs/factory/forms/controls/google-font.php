<?php
	 ...
	 * @since 1.0.0
	 */
	class Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_GoogleFontControl extends Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_FontControl {
		...
		public function __construct($options, $form, $provider = null)
		{
			...
			$this->google_font_data = new Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_HiddenControl($option_google_font_data, $form, $provider);
		...
		public function getDefaultFonts()
		{
			...
			$fontsCommon = array(
				'group',
				__('Standard:', 'wbcr_factory_forms_0c0d8ea3f46097b6066de1bed10ef3d9_453'),
				array(
			...
			$fontsGoogleFonts = array('group', __('Google Fonts:', 'wbcr_factory_forms_0c0d8ea3f46097b6066de1bed10ef3d9_453'), array());
		...
		protected function getGoogleFonts()
		{
			...
			if( is_wp_error($response) ) {
				...
				$this->error = __('Unable to retrieve the list of Google Fonts.', 'wbcr_factory_forms_0c0d8ea3f46097b6066de1bed10ef3d9_453');
			...
			if( !isset($response['body']) ) {
				...
				$this->error = __('Invalide response from the Google Fonts API.', 'wbcr_factory_forms_0c0d8ea3f46097b6066de1bed10ef3d9_453');
			...
			if( empty($body->items) ) {
				...
				$this->error = __('Unexpected error. The list of Google Fonts are empty.', 'wbcr_factory_forms_0c0d8ea3f46097b6066de1bed10ef3d9_453');
