<?php
	...
	if( !class_exists('Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_MultipleTextboxControl') ) {

		class Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_MultipleTextboxControl extends Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_Control {
			...
			public function html()
			{
				...
				<div class="factory-multiple-textbox-group">
					...
					<button class="btn btn-default btn-small factory-mtextbox-add-item">
						<i class="fa fa-plus" aria-hidden="true"></i> <?php _e('Add new', 'wbcr_factory_forms_0c0d8ea3f46097b6066de1bed10ef3d9_453') ?>
					</button>
				</div>
