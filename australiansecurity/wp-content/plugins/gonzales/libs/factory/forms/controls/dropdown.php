<?php
	...
	if ( ! class_exists( 'Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_DropdownControl' ) ) {
		
		class Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_DropdownControl extends Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_Control {
				...
				if ( $this->isAjax() ) {
                    ...
                    <script>
						window['<?php echo $ajax_id ?>'] = {
							...
							'empty_list': '<?php echo $this->getOption( 'empty', __( 'The list is empty.', 'wbcr_factory_forms_0c0d8ea3f46097b6066de1bed10ef3d9_453' ) ) ?>'
						};
                    </script>
					<?php
			...
			protected function defaultHtml() {
				...
				$empty_list = $this->getOption( 'empty', __( '- empty -', 'wbcr_factory_forms_0c0d8ea3f46097b6066de1bed10ef3d9_453' ) );
			...
			protected function printItems( $items, $selected = null ) {
				...
				foreach ( (array) $items as $item ) {
					...
					if ( isset( $item['type'] ) || isset( $item['value'] ) ) {
						...
						$title = isset( $item['title'] ) ? $item['title'] : __( '- empty -', 'wbcr_factory_forms_0c0d8ea3f46097b6066de1bed10ef3d9_453' );
