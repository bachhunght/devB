<?php
	...
	if( !class_exists('Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_CheckboxControl') ) {

		class Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_CheckboxControl extends Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_Control {
			...
			protected function buttonsHtml()
			{
				...
				<div <?php $this->attrs() ?>>
					<button type="button" class="btn btn-default btn-small btn-sm factory-on <?php if( $value ) {
						echo 'active';
					} ?>"><?php _e('On', 'wbcr_factory_forms_0c0d8ea3f46097b6066de1bed10ef3d9_453') ?></button>
					<button type="button" class="btn btn-default btn-small btn-sm factory-off <?php if( !$value ) {
						echo 'active';
					} ?>" data-value="0"><?php _e('Off', 'wbcr_factory_forms_0c0d8ea3f46097b6066de1bed10ef3d9_453') ?></button>
