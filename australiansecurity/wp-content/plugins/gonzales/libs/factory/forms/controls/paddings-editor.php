<?php
	...
	if( !class_exists('Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_PaddingsEditorControl') ) {

		class Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_PaddingsEditorControl extends Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_Control {
				...
				<div <?php $this->attrs() ?>
					...
					<div class="factory-slider-container">
						<label class="factory-title">
							<?php _e('Select a side and move the slider to set up:', 'wbcr_factory_forms_0c0d8ea3f46097b6066de1bed10ef3d9_453') ?>
						</label>
