<?php
	...
	if( !class_exists('Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_ListControl') ) {

		class Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_ListControl extends Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_Control {
				...
				if( $this->isAjax() ) {
					...
					<script>
						window['<?php echo $ajax_id ?>'] = {
							...
							'emptyList': '<?php echo $this->getOption('empty', __('The list is empty.', 'wbcr_factory_forms_0c0d8ea3f46097b6066de1bed10ef3d9_453') ) ?>'
						};
					</script>
					<?php
			...
			protected function checklistHtml()
			{
				...
				$emptyList = $this->getOption('empty', __('The list is empty.', 'wbcr_factory_forms_0c0d8ea3f46097b6066de1bed10ef3d9_453'));
