<?php
	...
	if( !class_exists('Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_WpEditorControl') ) {

		class Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_WpEditorControl extends Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_Control {
			...
			protected function beforeHtml()
			{
				...
				if( !isset($this->options['tinymce']['content_css']) ) {
					$this->options['tinymce']['content_css'] = FACTORY_FORMS_0C0D8EA3F46097B6066DE1BED10EF3D9_453_URL . '/assets/css/editor.css';
				}
			}
