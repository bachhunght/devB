<?php
	...
	if( !class_exists('Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_FontControl') ) {

		class Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_FontControl extends Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->size = new Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_IntegerControl($option_font_size, $form, $provider);
				$this->family = new Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_DropdownControl($option_font_family, $form, $provider);
				$this->color = new Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_ColorControl($optionFontColor, $form, $provider);
			...
			public function getFonts()
			{
				...
				$fonts = apply_filters('wbcr_factory_forms_0c0d8ea3f46097b6066de1bed10ef3d9_453_fonts', $fonts);
				$fonts = apply_filters('wbcr_factory_forms_0c0d8ea3f46097b6066de1bed10ef3d9_453_fonts-' . $this->options['name'], $fonts);
			...
			public function getDefaultFonts()
			{
				...
				$fonts = array(
					...
					array('inherit', __('(use default website font)', 'wbcr_factory_forms_0c0d8ea3f46097b6066de1bed10ef3d9_453')),
					array(
						'group',
						__('Sans Serif:', 'wbcr_factory_forms_0c0d8ea3f46097b6066de1bed10ef3d9_453'),
						array(
					...
					array(
						'group',
						__('Serif:', 'wbcr_factory_forms_0c0d8ea3f46097b6066de1bed10ef3d9_453'),
						array(
							array(
					...
					array(
						'group',
						__('Monospaced:', 'wbcr_factory_forms_0c0d8ea3f46097b6066de1bed10ef3d9_453'),
						array(
