<?php
	 ...
	 *  // see FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_DropdownControl
	 * 'dropdown' => array(
	 ...
	 *    ),
	 * // see FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_RadioColorsControl
	 * 'colors' => array(
	 *   // a callback to return items or an array of items to select
	 *   'data' => array(
	...
	if( !class_exists('Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_DropdownAndColorsControl') ) {
		
		class Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_DropdownAndColorsControl extends Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->dropdown = new Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_DropdownControl($options['dropdown'], $form, $provider);
				$this->colors = new Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_RadioColorsControl($options['colors'], $form, $provider);
