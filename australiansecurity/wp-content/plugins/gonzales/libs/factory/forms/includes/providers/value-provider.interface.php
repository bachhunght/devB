<?php
	...
	if( !class_exists('Wbcr_IFactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_ValueProvider') ) {
		/**
		 * The interface for all value provides.
		 *
		 * @since 1.0.0
		 */
		interface Wbcr_IFactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_ValueProvider {
