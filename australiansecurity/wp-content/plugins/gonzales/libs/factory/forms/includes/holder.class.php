<?php
	...
	if( !class_exists('Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_Holder') ) {
		 ...
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_Holder extends Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_FormElement {

			/**
			 * Holder Elements.
			 *
			 * @since 1.0.0
			 * @var Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_Control[]
			 */
			...
			function render()
			{
				...
				foreach($this->elements as $element) {
					...
					do_action('wbcr_factory_723e1da7c1403346cdca8f259c016fc4_456_form_before_element_' . $element->getOption('name'));
