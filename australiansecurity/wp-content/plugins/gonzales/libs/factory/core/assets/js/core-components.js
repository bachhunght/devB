...
(function($) {
	...
	var externalAddon = {
		...
		events: function() {
			...
			$(document).on('click', '.wfactory-723e1da7c1403346cdca8f259c016fc4_456-process-button', function() {
				var $this = $(this),
				...
				var action = ('creativemotion' === storage)
				             ? 'wfactory-723e1da7c1403346cdca8f259c016fc4_456-creativemotion-install-plugin'
				             : 'install-plugin';
				...
				if( storage === 'freemius' || ((storage === 'wordpress' || storage === 'creativemotion' || storage === 'internal') && (plugin_action === 'activate' || plugin_action === 'deactivate')) ) {
					action = 'wfactory-723e1da7c1403346cdca8f259c016fc4_456-intall-component';
				...
				$.wfactory_723e1da7c1403346cdca8f259c016fc4_456.hooks.run('core/components/pre_update', [$this, data]);

				self.sendRequest(data, function(response) {
					if( !response || !response.success ) {
						$.wfactory_723e1da7c1403346cdca8f259c016fc4_456.hooks.run('core/components/update_error', [
							$this,
							data,
							response
						]);
					...
					if( response.success ) {
						...
						if( plugin_action === 'install' ) {
							...
							$.wfactory_723e1da7c1403346cdca8f259c016fc4_456.hooks.run('core/components/installed', [
								$this,
								data,
								response
							]);
							...
							$.wfactory_723e1da7c1403346cdca8f259c016fc4_456.hooks.run('core/components/pre_activate', [
								$this,
								data,
								response
							]);
							...
							$.wfactory_723e1da7c1403346cdca8f259c016fc4_456.hooks.run('core/components/deactivated', [
								$this,
								data,
								response
							]);
							...
							$.wfactory_723e1da7c1403346cdca8f259c016fc4_456.hooks.run('core/components/deleted', [$this, data, response]);
						}
					} else {
						if( plugin_action === 'install' ) {
					...
					$.wfactory_723e1da7c1403346cdca8f259c016fc4_456.hooks.run('core/components/updated', [$this, data, response]);
				});
		...
		sendRequestToComponentActivationPrepare: function(componentButton, sendData, button_i18n) {
			...
			sendData.action = 'wfactory-723e1da7c1403346cdca8f259c016fc4_456-prepare-component';
			...
			this.sendRequest(sendData, function(response) {
				...
				if( !response || !response.success ) {
					...
					$.wfactory_723e1da7c1403346cdca8f259c016fc4_456.hooks.run('core/components/activation_error', [
						componentButton,
						sendData,
						response
					]);
				...
				$.wfactory_723e1da7c1403346cdca8f259c016fc4_456.hooks.run('core/components/activated', [
					componentButton,
					sendData,
					response
				]);
		...
		sendRequest: function(data, callback) {
			...
			$.ajax(ajaxurl, {
				...
				error: function(xhr, ajaxOptions, thrownError) {
					...
					$.wfactory_723e1da7c1403346cdca8f259c016fc4_456.hooks.run('core/components/ajax_error', [
						xhr,
						ajaxOptions,
						thrownError
					]);
