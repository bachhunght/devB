...
namespace WBCR\Factory_723e1da7c1403346cdca8f259c016fc4_456\Components;
...
class Install_Button {
	...
	protected $classes = [
		'button',
		'wfactory-723e1da7c1403346cdca8f259c016fc4_456-process-button'
	];
	protected $data = [];
	protected $base_path;
	 ...
	 * @since  4.3.3
	 */
	public function __construct(\Wbcr_Factory723e1da7c1403346cdca8f259c016fc4_456_Plugin $plugin, $type, $plugin_slug)
	{
		...
		$this->add_data('i18n', \WBCR\FactoryTemplates_204e5d1397aaf784fcbb05c582936ff1_107\Helpers::getEscapeJson($this->get_i18n()));
	...
	{
		return [
			'activate' => __('Activate', 'wbcr_factory_723e1da7c1403346cdca8f259c016fc4_456'),
			'install' => __('Install', 'wbcr_factory_723e1da7c1403346cdca8f259c016fc4_456'),
			'deactivate' => __('Deactivate', 'wbcr_factory_723e1da7c1403346cdca8f259c016fc4_456'),
			'delete' => __('Delete', 'wbcr_factory_723e1da7c1403346cdca8f259c016fc4_456'),
			'loading' => __('Please wait...', 'wbcr_factory_723e1da7c1403346cdca8f259c016fc4_456'),
			'preparation' => __('Preparation...', 'wbcr_factory_723e1da7c1403346cdca8f259c016fc4_456'),
			'read' => __('Read more', 'wbcr_factory_723e1da7c1403346cdca8f259c016fc4_456')
		];
	}
