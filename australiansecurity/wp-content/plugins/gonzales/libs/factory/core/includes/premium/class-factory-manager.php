...
namespace WBCR\Factory_723e1da7c1403346cdca8f259c016fc4_456\Premium;
...
class Manager {
	 ...
	 * @throws Exception
	 */
	public function __construct( Wbcr_Factory723e1da7c1403346cdca8f259c016fc4_456_Plugin $plugin, array $settings ) {
		$this->plugin   = $plugin;
	 ...
	 * @throws Exception
	 */
	public static function instance( Wbcr_Factory723e1da7c1403346cdca8f259c016fc4_456_Plugin $plugin, array $settings ) {
	...
	public function instance_provider() {
		...
		if ( isset( self::$providers[ $provider_name ] ) && class_exists( self::$providers[ $provider_name ] ) ) {
			if ( self::$providers[ $provider_name ] instanceof Provider ) {
				throw new Exception( "Provider {$provider_name} must extend the class WBCR\Factory_723e1da7c1403346cdca8f259c016fc4_456\Premium\Provider interface!" );
			}
