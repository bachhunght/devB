 ...
 */
// @formatter:off
if ( ! class_exists( 'Wbcr_Factory723e1da7c1403346cdca8f259c016fc4_456_Requirements' ) ) {
	class Wbcr_Factory723e1da7c1403346cdca8f259c016fc4_456_Requirements {
		...
		protected function get_notice_text() {
			...
			$notice_default_text .= sprintf( __( 'The %s plugin has stopped.', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107' ), $this->plugin_title ) . ' ';
		...
		protected function get_php_incompat_text() {
			return sprintf( __( 'You need to update the PHP version to %s or higher!', 'wbcr_factory_723e1da7c1403346cdca8f259c016fc4_456' ), $this->required_php_version );
		}
		...
		protected function get_wp_incompat_text() {
			return sprintf( __( 'You need to update WordPress to %s or higher!', 'wbcr_factory_723e1da7c1403346cdca8f259c016fc4_456' ), $this->required_wp_version );
		}
		...
		protected function get_plugin_already_activate_text() {
			return sprintf( __( 'Plugin %s is already activated, you are trying to activate it again.', 'wbcr_factory_723e1da7c1403346cdca8f259c016fc4_456' ), $this->plugin_title );
		}
	}
}
// @formatter:on