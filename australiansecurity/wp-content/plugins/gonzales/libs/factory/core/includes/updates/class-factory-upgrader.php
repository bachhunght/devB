...
class Upgrader {
	 ...
	 *  'freemius' => '\WBCR\Factory_723e1da7c1403346cdca8f259c016fc4_456\Updates\Wordpress_Repository'
	 * ]
	 */
	...
	public function __construct(Wbcr_Factory723e1da7c1403346cdca8f259c016fc4_456_Plugin $plugin)
	{
		...
		self::$repositories['wordpress'] = '\WBCR\Factory_723e1da7c1403346cdca8f259c016fc4_456\Updates\Wordpress_Repository';
		self::$repositories['github'] = '\WBCR\Factory_723e1da7c1403346cdca8f259c016fc4_456\Updates\Github_Repository';
	...
	protected function get_repository($repository_name)
	{
		...
		if( isset(self::$repositories[$repository_name]) && class_exists(self::$repositories[$repository_name]) ) {
			if( self::$repositories[$repository_name] instanceof Repository ) {
				throw new Exception("Repository {$repository_name} must extend the class WBCR\Factory_723e1da7c1403346cdca8f259c016fc4_456\Updates\Repository interface!");
			}
