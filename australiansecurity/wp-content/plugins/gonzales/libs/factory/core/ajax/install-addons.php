 ...
 */
function wfactory_723e1da7c1403346cdca8f259c016fc4_456_install_components($plugin_instance)
{
	...
	if( !current_user_can('update_plugins') ) {
		wp_die(__('You don\'t have enough capability to edit this information.', 'wbcr_factory_723e1da7c1403346cdca8f259c016fc4_456'), __('Something went wrong.'), 403);
	}

	if( empty($slug) || empty($action) ) {
		wp_send_json_error(['error_message' => __('Required attributes are not passed or empty.', 'wbcr_factory_723e1da7c1403346cdca8f259c016fc4_456')]);
	}
	$success = false;
	$send_data = [];
	...
	if( $storage == 'internal' ) {
		if( $action == 'activate' ) {
			...
			wp_send_json_error(['error_message' => __('You are trying to perform an invalid action.', 'wbcr_factory_723e1da7c1403346cdca8f259c016fc4_456')]);
		}
	...
	/*if ( $action == 'deactivate' ) {
		...
		if ( $is_need_rewrite_rules ) {
			$send_data['need_rewrite_rules'] = sprintf( '<span class="wbcr-clr-need-rewrite-rules-message">' . __( 'When you deactivate some components, permanent links may work incorrectly. If this happens, please, <a href="%s">update the permalinks</a>, so you could complete the deactivation.', 'wbcr_factory_723e1da7c1403346cdca8f259c016fc4_456' ), admin_url( 'options-permalink.php' ) . '</span>' );
		}
	}*/
	...
	wp_send_json_error(['error_message' => __('An unknown error occurred during the activation of the component.', 'wbcr_factory_723e1da7c1403346cdca8f259c016fc4_456')]);
}
 ...
 */
function wfactory_723e1da7c1403346cdca8f259c016fc4_456_prepare_component($plugin_instance)
{
	check_ajax_referer('updates');
	...
	if( !current_user_can('update_plugins') ) {
		wp_send_json_error(['error_message' => __('You don\'t have enough capability to edit this information.', 'wbcr_factory_723e1da7c1403346cdca8f259c016fc4_456')], 403);
	}

	if( empty($component_name) ) {
		wp_send_json_error(['error_message' => __('Required attribute [component_name] is empty.', 'wbcr_factory_723e1da7c1403346cdca8f259c016fc4_456')]);
	}
	// todo: для совместимости с плагином Clearfy
	if( "wbcr_clearfy" === $plugin_instance->getPluginName() ) {
 ...
 */
function wfactory_723e1da7c1403346cdca8f259c016fc4_456_creativemotion_install_plugin($plugin_instance)
{
	check_ajax_referer('updates');
