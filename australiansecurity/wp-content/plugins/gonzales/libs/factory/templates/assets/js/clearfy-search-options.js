(function($) {
	...
	$(document).ready(function() {
		...
		$('#wbcr-factory-templates-204e5d1397aaf784fcbb05c582936ff1_107__autocomplete').wfactory_clearfy_autocomplete({
			lookup: wfactory_clearfy_search_options,
			onSelect: function(suggestion) {
				$('#wbcr-factory-templates-204e5d1397aaf784fcbb05c582936ff1_107__autocomplete').prop("disabled", true);
