...
if ( ! class_exists( 'WBCR\FactoryTemplates_204e5d1397aaf784fcbb05c582936ff1_107\ImpressiveLite' ) ) {
	/**
	 * Class Wbcr_FactoryPagesa5b5ef22d149cd7ce4758112710a341d_455_ImpressiveLiteTemplate
	 */
	abstract class ImpressiveLite extends \WBCR\FactoryTemplates_204e5d1397aaf784fcbb05c582936ff1_107\Pages\PageBase {
		...
		public function assets( $scripts, $styles ) {
			...
			$this->styles->add( FACTORY_TEMPLATES_204E5D1397AAF784FCBB05C582936FF1_107_URL . '/pages/templates/impressive-lite/assets/css/impressive-lite.page.template.css' );
		}
		...
		protected function showPageSubMenu() {
			...
			?>
            <div class="w-factory-templates-204e5d1397aaf784fcbb05c582936ff1_107-horizontal-menu wp-clearfix">
				<?php foreach ( (array) $page_menu as $page_screen => $page ): ?>
					...
					if ( $page_screen == $this->getResultId() ) {
						$active_tab = ' w-factory-templates-204e5d1397aaf784fcbb05c582936ff1_107-horizontal-menu__nav-tab-active';
					}
					?>
                    <a href="<?php echo $page['url'] ?>" id="<?php echo esc_attr( $page_screen ) ?>-tab"
                       class="w-factory-templates-204e5d1397aaf784fcbb05c582936ff1_107-horizontal-menu__nav-tab<?php echo esc_attr( $active_tab ) ?>">
		...
		protected function showOptions() {
            ...
            <div id="WBCR" class="wrap">
                <div class="wbcr-factory-templates-204e5d1397aaf784fcbb05c582936ff1_107-impressive-lite-page-template factory-bootstrap-6a13d960fb08ebdb339a72cc7fe28071_457 factory-fontawesome-000">
                                    ...
                                    <form method="post" class="form-horizontal">
										...
										if ( $this->type == 'options' ) {
											...
											$submit_button = "<input name='{$this->plugin->getPluginName()}_save_action'
                                                   ...
                                                   value='" . __( 'Save', 'wbcr_factory_pages_a5b5ef22d149cd7ce4758112710a341d_455' ) . "'>";
										}
										?>
