 ...
 *
 * Этот класс унаследован от стандартного шаблона страницы \Wbcr_FactoryPagesa5b5ef22d149cd7ce4758112710a341d_455_ImpressiveThemplate,
 ...
 *
 * @package WBCR\FactoryTemplates_204e5d1397aaf784fcbb05c582936ff1_107\Pages
 * @author        Alex Kovalev <alex.kovalevv@gmail.com>, Github: https://github.com/alexkovalevv
 * @since         2.2.2
 */
class Setup extends \WBCR\FactoryTemplates_204e5d1397aaf784fcbb05c582936ff1_107\Impressive {
	...
	public function __construct(\Wbcr_Factory723e1da7c1403346cdca8f259c016fc4_456_Plugin $plugin)
	{
		...
		$this->menu_title = __('Setup master', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107');
		$this->page_menu_short_description = __('Setup master', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107');
		parent::__construct($plugin);
	}

	public function getPageTitle()
	{
		return __('Setup', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107');
	}
	...
	public function assets($scripts, $styles)
	{
		...
		$this->styles->add(FACTORY_TEMPLATES_204E5D1397AAF784FCBB05C582936FF1_107_URL . '/assets/css/page-setup.css');
	...
	{
		?>
		<div class="w-factory-templates-204e5d1397aaf784fcbb05c582936ff1_107-setup">
			<ol class="w-factory-templates-204e5d1397aaf784fcbb05c582936ff1_107-setup-steps">
			...
			<div class="w-factory-templates-204e5d1397aaf784fcbb05c582936ff1_107-setup-content">
				<?php echo $content; ?>
			</div>
			<a class="w-factory-templates-204e5d1397aaf784fcbb05c582936ff1_107-setup-footer-links" href="<?php echo esc_url($this->get_close_wizard_url()); ?>">
				<?php _e('Not now', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107') ?>
			</a>
		</div>
		<?php
	}
