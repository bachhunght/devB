...
namespace WBCR\FactoryTemplates_204e5d1397aaf784fcbb05c582936ff1_107\Pages;
...
/**
 * Class Wbcr_FactoryPagesa5b5ef22d149cd7ce4758112710a341d_455_ImpressiveThemplate
 *
 ...
 */
class PageBase extends \WBCR\FactoryTemplates_204e5d1397aaf784fcbb05c582936ff1_107\Impressive {
	 ...
	 *
	 * @param \Wbcr_Factory723e1da7c1403346cdca8f259c016fc4_456_ScriptList $scripts
	 * @param \Wbcr_Factory723e1da7c1403346cdca8f259c016fc4_456_StyleList $styles
	 *
	 * @return void
	 * @see Wbcr_FactoryPagesa5b5ef22d149cd7ce4758112710a341d_455_AdminPage
	 *
	 */
	public function assets($scripts, $styles)
	{
		...
		$this->styles->add(FACTORY_TEMPLATES_204E5D1397AAF784FCBB05C582936FF1_107_URL . '/assets/css/clearfy-base.css');
		...
		if( !($this->plugin->has_premium() && $this->plugin->premium->is_active()) ) {
			$this->scripts->add(FACTORY_TEMPLATES_204E5D1397AAF784FCBB05C582936FF1_107_URL . '/assets/js/clearfy-widgets.js', [
				'jquery',
				'wfactory-723e1da7c1403346cdca8f259c016fc4_456-core-general',
				'wbcr-factory-templates-204e5d1397aaf784fcbb05c582936ff1_107-global'
			], 'wbcr-factory-templates-204e5d1397aaf784fcbb05c582936ff1_107-widgets');
		}

		// Script for search form on plugin options
		if( $this->show_search_options_form ) {
			$this->styles->add(FACTORY_TEMPLATES_204E5D1397AAF784FCBB05C582936FF1_107_URL . '/assets/css/libs/autocomplete.css');

			$this->scripts->add(FACTORY_TEMPLATES_204E5D1397AAF784FCBB05C582936FF1_107_URL . '/assets/js/libs/jquery.autocomplete.min.js');
			$this->scripts->add(FACTORY_TEMPLATES_204E5D1397AAF784FCBB05C582936FF1_107_URL . '/assets/js/clearfy-search-options.js');
		}
	...
	{
		wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107_subscribe($this->plugin);
	}

	/**
	 * @return \Wbcr_Factory723e1da7c1403346cdca8f259c016fc4_456_Request
	 */
	...
	protected function getPageWidgets($position = 'bottom')
	{
		 ...
		 */
		$widgets = wbcr_factory_723e1da7c1403346cdca8f259c016fc4_456_apply_filters_deprecated('wbcr_factory_pages_a5b5ef22d149cd7ce4758112710a341d_455_imppage_get_widgets', [
			$widgets,
			$position,
			$this->plugin,
			$this
	...
	public function showBusinessSuggetionWidget()
	{
		...
		$default_features = [
			'4_premium' => __('4 premium components now;', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107'),
			'40_premium' => __('40 new premium components within a year for the single price;', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107'),
			'multisite_support' => __('Multisite support;', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107'),
			'advance_settings' => __('Advanced settings;', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107'),
			'no_ads' => __('No ads;', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107'),
			'perfect_support' => __('Perfect support.', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107')
		];

		/**
		 * @since 2.0.8 - added
		 */
		$suggetion_title = __('MORE IN CLEARFY <span>BUSINESS</span>', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107');
		 ...
		 */
		$suggetion_features = wbcr_factory_723e1da7c1403346cdca8f259c016fc4_456_apply_filters_deprecated('wbcr/clearfy/page_bussines_suggetion_features', [
			$default_features,
		...
		?>
		<div class="wbcr-factory-sidebar-widget wbcr-factory-templates-204e5d1397aaf784fcbb05c582936ff1_107-pro-suggettion">
			...
			<a href="<?php echo $purchase_url ?>" class="wbcr-factory-purchase-premium" target="_blank"
			   rel="noopener">
				<?php printf(__('Upgrade for $%s', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107'), $upgrade_price) ?>
			</a>
		</div>
		<?php
	}
		...
		<div class="wbcr-factory-sidebar-widget">
			<ul>
				<li>
					...
					- <?php _e('A neutral setting that can not harm your site, but you must be sure that you need to use it.', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107'); ?>
				</li>
				<li>
					...
					- <?php _e('When set this option, you must be careful. Plugins and themes may depend on this function. You must be sure that you can disable this feature for the site.', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107'); ?>
				</li>
				<li>
					...
					- <?php _e('Absolutely safe setting, We recommend to use.', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107'); ?>
				</li>
			</ul>
			----------<br>
			<p><?php _e('Hover to the icon to get help for the feature you selected.', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107'); ?></p>
		</div>
		<?php
	}
	...
	public function showRatingWidget(array $args)
	{
		...
		$page_url = apply_filters('wbcr_factory_pages_a5b5ef22d149cd7ce4758112710a341d_455_imppage_rating_widget_url', $page_url, $this->plugin->getPluginName(), $this->getResultId());

		?>
		<div class="wbcr-factory-sidebar-widget">
			<p>
				<strong><?php _e('Do you want the plugin to improved and update?', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107'); ?></strong>
			</p>
			<p><?php _e('Help the author, leave a review on wordpress.org. Thanks to feedback, I will know that the plugin is really useful to you and is needed.', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107'); ?></p>
			<p><?php _e('And also write your ideas on how to extend or improve the plugin.', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107'); ?></p>
			<p>
				<i class="wbcr-factory-icon-5stars"></i>
				<a href="<?php echo $page_url; ?>" title="Go rate us" target="_blank">
					<strong><?php _e('Go rate us and push ideas', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107'); ?></strong>
				</a>
			</p>
		</div>
		<?php
	...
	public function showDonateWidget()
	{
		...
		<div class="wbcr-factory-sidebar-widget">
			<p>
				<strong><?php _e('Donation for plugin development', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107'); ?></strong>
			</p>
			<?php if( get_locale() !== 'ru_RU' ): ?>
				<form id="wbcr-factory-paypal-donation-form" action="https://www.paypal.com/cgi-bin/webscr"
					...
					<input type="image" src="<?php echo FACTORY_TEMPLATES_204E5D1397AAF784FCBB05C582936FF1_107_URL ?>/templates/assets/img/paypal-donate.png"
	...
	public function showSupportWidget()
	{
		...
		<div id="wbcr-clr-support-widget" class="wbcr-factory-sidebar-widget">
			<p><strong><?php _e('Having Issues?', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107'); ?></strong></p>
			<div class="wbcr-clr-support-widget-body">
				<p>
					<?php _e('We provide free support for this plugin. If you are pushed with a problem, just create a new ticket. We will definitely help you!', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107'); ?>
				</p>
				<ul>
					<li><span class="dashicons dashicons-sos"></span>
						<a href="<?php echo $free_support_url; ?>" target="_blank"
						   rel="noopener"><?php _e('Get starting free support', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107'); ?></a>
					</li>
					<li style="margin-top: 15px;background: #fff4f1;padding: 10px;color: #a58074;">
						<span class="dashicons dashicons-warning"></span>
						<?php printf(__('If you find a php error or a vulnerability in plugin, you can <a href="%s" target="_blank" rel="noopener">create ticket</a> in hot support that we responded instantly.', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107'), $hot_support_url); ?>
					</li>
				</ul>
			</div>
		</div>
	...
	public function showSubscribeWidget()
	{
		...
		<div id="wbcr-clr-subscribe-widget" class="wbcr-factory-sidebar-widget wbcr-factory-subscribe-widget">
			<p><strong><?php _e('Subscribe to plugin’s newsletter', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107'); ?></strong></p>
			<div class="wbcr-clr-subscribe-widget-body">
				...
				<div class="wbcr-factory-subscribe-widget__message-contanier">
					<div class="wbcr-factory-subscribe-widget__text wbcr-factory-subscribe-widget__text--success">
						<?php _e("Thank you, you have successfully subscribed!", 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107') ?>
					</div>
					<div class="wbcr-factory-subscribe-widget__text wbcr-factory-subscribe-widget__text--success2">
						<?php _e("Thank you for your subscription, a confirmation email has been sent to you. You need to confirm your subscription to complete this process.", 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107'); ?>
					</div>
				</div>
				...
				<form id="wbcr-factory-subscribe-widget__subscribe-form" method="post" data-nonce="<?php echo wp_create_nonce('clearfy_subscribe_for_' . $this->plugin->getPluginName()) ?>">
					<input id="wbcr-factory-subscribe-widget__email" class="wbcr-factory-subscribe-widget__field" type="email" name="email" placeholder="<?php _e('Enter your email address', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107'); ?>" required>
					<label class="wbcr-factory-subscribe-widget__checkbox-label">
						...
						<?php echo sprintf(__("I confirm to subscribe to the CreativeMotion newsletter to receive the latest news. You can find how we use your information on our %s Privacy Policy %s", 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107'), '<a href="' . $terms . '" target="_blank">', '</a>'); ?>
					</label>
					...
					<input type="submit" class="btn wbcr-factory-subscribe-widget__button" value="<?php _e('Subscribe', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107'); ?>">
				</form>
			</div>
		</div>
	...
	public function register_options_to_search()
	{
		...
		\WBCR\FactoryTemplates_204e5d1397aaf784fcbb05c582936ff1_107\Search_Options::register_options($options, $page_url, $page_id);
	}
	...
	public function printAllNotices()
	{
		...
		?>
		<div id="wbcr-factory-templates-204e5d1397aaf784fcbb05c582936ff1_107__search_options_form" class="wbcr-factory-templates-204e5d1397aaf784fcbb05c582936ff1_107__autocomplete-wrap">
			<label for="autocomplete" class="wbcr-factory-templates-204e5d1397aaf784fcbb05c582936ff1_107__autocomplete-label">
				<?php _e('Can\'t find the settings you need? Use the search by the plugin options:', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107'); ?>
			</label>
			<input type="text" placeholder="<?php _e('Enter the option name to search...', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107'); ?>" name="country" id="wbcr-factory-templates-204e5d1397aaf784fcbb05c582936ff1_107__autocomplete"/>
