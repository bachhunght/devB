...
class Components extends \WBCR\FactoryTemplates_204e5d1397aaf784fcbb05c582936ff1_107\Pages\PageBase {
	...
	{
		$this->menu_title = __('Components', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107');
		$this->page_menu_short_description = __('More features for plugin', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107');
	...
	public function assets($scripts, $styles)
	{
		...
		$this->styles->add(FACTORY_TEMPLATES_204E5D1397AAF784FCBB05C582936FF1_107_URL . '/assets/css/components.css');
	 ...
	 *
	 * @return array
	 * @see libs\factory\pages\themplates\FactoryPagesa5b5ef22d149cd7ce4758112710a341d_455_ImpressiveThemplate
	 */
	public function getActionNotices($notices)
	{
		$notices[] = [
			...
			'type' => 'success',
			'message' => __('Components have been successfully updated to the latest version.', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107')
		];
		...
		$notices[] = [
			...
			'type' => 'danger',
			'message' => __('To use premium components, you need activate a license!', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107') . '<a href="admin.php?page=license-wbcr_clearfy" class="btn btn-gold">' . __('Activate license', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107') . '</a>'
		];
	...
	public function showPageContent()
	{
		...
		?>
		<div class="wbcr-factory-page-group-header"><?php _e('<strong>Plugin Components</strong>.', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107') ?>
			<p>
				<?php _e('These are components of the plugin bundle. When you activate the plugin, all the components turned on by default. If you don’t need some function, you can easily turn it off on this page.', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107') ?>
			</p>
		</div>
		<div class="wbc-factory-templates-204e5d1397aaf784fcbb05c582936ff1_107-components">
			<?php
			/**
			 * @since 1.4.0
			 */
					...
					<div class="plugin-card-bottom">
						<?php if( !(isset($component['disable_button']) && $component['disable_button']) ): ?>
							<?php if( 'premium' === $component['build'] && !($this->plugin->premium->is_activate() && $this->plugin->premium->is_install_package()) ): ?>
								<a target="_blank" href="<?php echo esc_url($component['url']) ?>" class="button button-default install-now"><?php _e('Read more', 'wbcr_factory_templates_204e5d1397aaf784fcbb05c582936ff1_107'); ?></a>
							<?php else: ?>
