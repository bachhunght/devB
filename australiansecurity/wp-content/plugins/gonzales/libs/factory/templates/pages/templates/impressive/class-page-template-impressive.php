...
namespace WBCR\FactoryTemplates_204e5d1397aaf784fcbb05c582936ff1_107;
...
if ( ! class_exists( 'WBCR\FactoryTemplates_204e5d1397aaf784fcbb05c582936ff1_107\Impressive' ) ) {
	/**
	 * Class Wbcr_FactoryPagesa5b5ef22d149cd7ce4758112710a341d_455_ImpressiveThemplate
	 */
	abstract class Impressive extends \Wbcr_FactoryPagesa5b5ef22d149cd7ce4758112710a341d_455_AdminPage {
		...
		public function __construct( \Wbcr_Factory723e1da7c1403346cdca8f259c016fc4_456_Plugin $plugin ) {
			$this->menuIcon = FACTORY_TEMPLATES_204E5D1397AAF784FCBB05C582936FF1_107_URL . '/pages/templates/impressive/assets/img/webcraftic-plugin-icon.png';
			//$allow_multisite = apply_filters('wbcr_factory_723e1da7c1403346cdca8f259c016fc4_456_core_admin_allow_multisite', false);
			...
			$this->title_plugin_action_link = __( 'Settings', 'wbcr_factory_pages_a5b5ef22d149cd7ce4758112710a341d_455' );
		 ...
		 * @return void
		 * @since 1.0.0
		 * @see   \FactoryPagesa5b5ef22d149cd7ce4758112710a341d_455_AdminPage
		 *
		 */
		public function assets( $scripts, $styles ) {
			...
			$this->styles->add( FACTORY_TEMPLATES_204E5D1397AAF784FCBB05C582936FF1_107_URL . '/pages/templates/impressive/assets/css/impressive.page.template.css' );
		}
		...
		public function flushCacheAndRulesAction() {
			...
			if ( class_exists( 'WBCR\FactoryTemplates_204e5d1397aaf784fcbb05c582936ff1_107\Helpers' ) ) {
				\WBCR\FactoryTemplates_204e5d1397aaf784fcbb05c582936ff1_107\Helpers::flushPageCache();
			}
		...
		protected function warningNotice() {
			/*if( WP_CACHE ) {
				$this->printWarningNotice(__("It seems that a caching/performance plugin is active on this site. Please manually invalidate that plugin's cache after making any changes to the settings below.", 'wbcr_factory_pages_a5b5ef22d149cd7ce4758112710a341d_455'));
			}*/
		...
		private function showActionsNotice() {
			$notices = [
				[
					...
					'type'       => 'success',
					'message'    => __( 'The settings have been updated successfully!', 'wbcr_factory_pages_a5b5ef22d149cd7ce4758112710a341d_455' ) . ( WP_CACHE ? '<br>' . __( "It seems that a caching/performance plugin is active on this site. Please manually invalidate that plugin's cache after making any changes to the settings below.", 'wbcr_factory_pages_a5b5ef22d149cd7ce4758112710a341d_455' ) : '' )
				]
			];
                ...
                <div class="wbcr-factory-control">
					...
					<?php if ( $this->type == 'options' ): ?>
                        <input name="<?php echo $this->plugin->getPluginName() ?>_save_action"
                               ...
                               value="<?php _e( 'Save', 'wbcr_factory_pages_a5b5ef22d149cd7ce4758112710a341d_455' ); ?>">
		...
		protected function showOptions() {
			$form = new \Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_Form( [
				'scope' => rtrim( $this->plugin->getPrefix(), '_' ),
				'name'  => $this->getResultId() . "-options"
			], $this->plugin );

			$form->setProvider( new \Wbcr_FactoryForms0c0d8ea3f46097b6066de1bed10ef3d9_453_OptionsValueProvider( $this->plugin ) );
			...
			if ( isset( $_POST[ $this->plugin->getPluginName() . '_save_action' ] ) ) {
				...
				if ( ! current_user_can( 'administrator' ) && ! current_user_can( $this->capabilitiy ) ) {
					wp_die( __( 'You do not have permission to edit page.', 'wbcr_factory_pages_a5b5ef22d149cd7ce4758112710a341d_455' ) );
				}
            ...
            <div id="WBCR" class="wrap">
                <div class="wbcr-factory-templates-204e5d1397aaf784fcbb05c582936ff1_107-impressive-page-template factory-bootstrap-6a13d960fb08ebdb339a72cc7fe28071_457 factory-fontawesome-000">
