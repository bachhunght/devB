 ...
 * @since 3.2.0
 */
class Wbcr_FactoryBootstrap6a13d960fb08ebdb339a72cc7fe28071_457_Manager {
	...
	public function loadAssets($hook)
	{
		...
		do_action('wbcr_factory_723e1da7c1403346cdca8f259c016fc4_456_bootstrap_enqueue_scripts', $hook);
		do_action('wbcr_factory_723e1da7c1403346cdca8f259c016fc4_456_bootstrap_enqueue_scripts_' . $this->plugin->getPluginName(), $hook);
	...
	protected function enqueueScripts(array $scripts, $type, array $dependencies)
	{
		...
		$cache_dir_path = FACTORY_BOOTSTRAP_6A13D960FB08EBDB339A72CC7FE28071_457_DIR . '/assets/cache/';
		$cache_dir_url = FACTORY_BOOTSTRAP_6A13D960FB08EBDB339A72CC7FE28071_457_URL . '/assets/cache/';
		...
		if( $cache_enable && file_exists($cache_filepath) ) {
			...
			foreach($scripts as $script_to_load) {
				...
				if( $cache_enable && $cache_dir_exists ) {
					$fname = FACTORY_BOOTSTRAP_6A13D960FB08EBDB339A72CC7FE28071_457_DIR . "/assets/$type-min/$script_to_load.min." . $type;
					...
					if( $type == 'js' ) {
						wp_enqueue_script(md5($script_to_load), FACTORY_BOOTSTRAP_6A13D960FB08EBDB339A72CC7FE28071_457_URL . "/assets/$type-min/$script_to_load.min." . $type, $is_first ? $dependencies : false, $this->plugin->getPluginVersion());
					} else {
						wp_enqueue_style(md5($script_to_load), FACTORY_BOOTSTRAP_6A13D960FB08EBDB339A72CC7FE28071_457_URL . "/assets/$type-min/$script_to_load.min." . $type, [], $this->plugin->getPluginVersion());
					}
					$is_first = false;
				}
			}
