...
namespace WBCR\FactoryAdverts_da9c21d3fe63c67e5c6c18d244e4abee_133;
...
class Base {
	 ...
	 * @author Alexander Kovalev <alex.kovalevv@gmail.com>
	 * @since  1.0.1
	 * @var \WBCR\FactoryAdverts_da9c21d3fe63c67e5c6c18d244e4abee_133\Creative_Motion_API
	 */
	private $api;
	 ...
	 */
	public function __construct( \Wbcr_Factory723e1da7c1403346cdca8f259c016fc4_456_Plugin $plugin, $settings ) {
		$this->plugin = $plugin;
	...
	public function register_dashboard_widget() {
		if ( $this->settings['dashboard_widget'] && current_user_can( 'manage_options' ) ) {
			...
			require_once FACTORY_ADVERTS_DA9C21D3FE63C67E5C6C18D244E4ABEE_133_DIR . '/includes/class-dashboard-widget.php';
