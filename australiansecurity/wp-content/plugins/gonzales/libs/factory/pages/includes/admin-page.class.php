...
if( !class_exists('Wbcr_FactoryPagesa5b5ef22d149cd7ce4758112710a341d_455_AdminPage') ) {

	class Wbcr_FactoryPagesa5b5ef22d149cd7ce4758112710a341d_455_AdminPage extends Wbcr_FactoryPagesa5b5ef22d149cd7ce4758112710a341d_455_Page {
		...
		public function connect()
		{
			...
			$this->hidden = apply_filters('wbcr_factory_723e1da7c1403346cdca8f259c016fc4_456_page_is_hidden_' . $result_id, $this->hidden);

			if( $this->hidden ) {
				return;
			}

			$this->internal = apply_filters('wbcr_factory_723e1da7c1403346cdca8f259c016fc4_456_page_is_internal_' . $result_id, $this->internal);
			...
			if( $this->request->get('page', 'none') == $result_id ) {
				...
				if( !$this->scripts->isEmpty('bootstrap') || !$this->styles->isEmpty('bootstrap') ) {
					add_action('wbcr_factory_723e1da7c1403346cdca8f259c016fc4_456_bootstrap_enqueue_scripts_' . $this->plugin->getPluginName(), [
						$this,
