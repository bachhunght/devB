...
if ( ! class_exists( 'Wbcr_FactoryPagesa5b5ef22d149cd7ce4758112710a341d_455_Page' ) ) {

	class Wbcr_FactoryPagesa5b5ef22d149cd7ce4758112710a341d_455_Page {
		...
		public function executeByName( $action ) {
			...
			if ( ! method_exists( $this, $actionFunction ) ) {
				...
				/*$custom_actions = apply_filters('wbcr/factory_pages_a5b5ef22d149cd7ce4758112710a341d_455/custom_actions', array(), $raw_action_name);
