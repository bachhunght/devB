<?php
	...
	add_action('admin_menu', 'Wbcr_FactoryPagesa5b5ef22d149cd7ce4758112710a341d_455::actionAdminMenu');
	add_action('network_admin_menu', 'Wbcr_FactoryPagesa5b5ef22d149cd7ce4758112710a341d_455::actionAdminMenu');
	...
	if( !class_exists('Wbcr_FactoryPagesa5b5ef22d149cd7ce4758112710a341d_455') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryPagesa5b5ef22d149cd7ce4758112710a341d_455 {

			/**
			 * @var Wbcr_FactoryPagesa5b5ef22d149cd7ce4758112710a341d_455_Page[]
			 */
			...
			public static function getPageUrl(Wbcr_Factory723e1da7c1403346cdca8f259c016fc4_456_Plugin $plugin, $page_id, $args = array())
			{
				if( isset(self::$pages[$plugin->getPluginName()]) ) {
	...
	if( !function_exists('wbcr_factory_pages_a5b5ef22d149cd7ce4758112710a341d_455_get_page_id') ) {
		/**
		 *
		 * @param Wbcr_Factory723e1da7c1403346cdca8f259c016fc4_456_Plugin $plugin
		 ...
		 * @return string
		 */
		function wbcr_factory_pages_a5b5ef22d149cd7ce4758112710a341d_455_get_page_id($plugin, $page_id)
		{
