        ...
        <ul class="testimonials-list">
            <?php 
                while (have_rows('testimonails')) : the_row(); 
                    ...
                    $client_name = get_post_meta($postObj->ID, 'client-name', true);
                    $client_area = get_post_meta($postObj->ID, 'client-area', true);
                    $testimonial_content = get_the_content(null, false, $postObj->ID);
                    $testimonial_video = get_post_meta($postObj->ID, 'testimonial-video-url', true);
            ?>
                <li>
                    <p><?php echo strip_tags($testimonial_content);?></p>
...
<section class="blog-info-home">
    <div class="container">
        ...
        <?php echo do_shortcode('[sp_wpcarousel id="1450"]'); ?>
    </div>
</section>
