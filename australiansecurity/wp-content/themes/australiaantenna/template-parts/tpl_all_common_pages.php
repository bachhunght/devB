...
$pageID=get_the_ID();
    ...
    if( empty( $bannerurl )) {
        $bannerurl = 'https://www.australianantennas.com.au/wp-content/uploads/2018/10/cctv-installation-two-image_new.jpg';
		...
		<div class="our-cctv-bx">
		   <div class="our-cctv-inner">
		      <div class="our-cctv-img">
			    <img src="<?php echo get_sub_field('services_image');?>" alt="<?php echo get_sub_field('services_name');?>">
			  </div>
			  <div class="col-cont">
			     <div class="col-icon"><img src="https://www.australiansecurity.com.au/wp-content/uploads/2021/03/camera-icons-1.png" alt="camera-icons-1"></div>
				 <h6><a href="#"><?php echo get_sub_field('services_name');?></a></h6>
			  </div>
		   </div>
		</div>
