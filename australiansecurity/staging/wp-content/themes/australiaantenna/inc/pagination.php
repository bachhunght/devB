...
function wp_pagenavi($before = '', $after = '') {
    ...
    if ($max_page > 1 || intval($pagenavi_options['always_show'])) {
        ...
        echo $before.'<div class="wp-pagenavi"><div class="pagination">'."\n";
...
function pagenavi_init() {
    ...
    $pagenavi_options = array(
        'pages_text' => __('Page %CURRENT_PAGE% of %TOTAL_PAGES%','wp-camy'),
        'current_text' => '%PAGE_NUMBER%',
        'page_text' => '%PAGE_NUMBER%',
        'first_text' => __('&laquo; First','wp-camy'),
        'last_text' => __('Last &raquo;','wp-camy'),
        'next_text' => __('&raquo;','wp-camy'),
        'prev_text' => __('&laquo;','wp-camy'),
        'dotright_text' => __('...','wp-camy'),
        'dotleft_text' => __('...','wp-camy'),
        'style' => 1,
        'num_pages' => 5,
        'always_show' => 0,
