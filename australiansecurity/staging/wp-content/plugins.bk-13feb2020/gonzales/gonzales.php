 ...
 * Framework Version: FACTORY_423_VERSION
 */
...
$wgnz_plugin_info = array(
	...
	'load_factory_modules' => array(
		array( 'libs/factory/bootstrap', 'factory_bootstrap_424', 'admin' ),
		array( 'libs/factory/forms', 'factory_forms_421', 'admin' ),
		array( 'libs/factory/pages', 'factory_pages_423', 'admin' ),
		array( 'libs/factory/clearfy', 'factory_clearfy_215', 'all' ),
		array( 'libs/factory/adverts', 'factory_adverts_105', 'admin')
	)
);

$wgnz_compatibility = new Wbcr_Factory423_Requirements( __FILE__, array_merge( $wgnz_plugin_info, array(
