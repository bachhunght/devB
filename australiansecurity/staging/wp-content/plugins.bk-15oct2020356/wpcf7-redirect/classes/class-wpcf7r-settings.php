		...
		$this->fields = array_merge(
			...
			array(
				array(
					...
					'placeholder'  => '',
					'helper'       => '',
					'supplemental' => __( 'Will open the actions post type and display debug feature', 'wpcf7-redirect' ),
					'default'      => '',
				),
			)
		);
				...
				<div class="postbox">
					<div class="padbox">
						...
						<?php if ( is_wpcf7r_debug() ) : ?>
							...
							<h3>RECREATE FROM DEBUG</h3>
							<textarea id="debug-info" style="width:100%;"></textarea>
							<button class="reacreate-from-debug button button-primary">RECREATE FROM DEBUG</button>
						<?php endif; ?>
					</div>
				</div>
			</div>
