...
class WGZ_Views {
	 ...
	 * @param Wbcr_FactoryClearfy215_PageBase $page
	 *
	 * @return bool|string       The page contents. False if the template doesn't exist.
	 */
	public function get_template( $template, $data = [], Wbcr_FactoryClearfy215_PageBase $page = null ) {
	 ...
	 * @param Wbcr_FactoryClearfy215_PageBase $page
	 */
	public function print_template( $template, $data = [], Wbcr_FactoryClearfy215_PageBase $page = null ) {
