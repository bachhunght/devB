...
<div class="wam-info-section">
    <div class="wam-info-section__warning">
        ...
        <p>
			<?php echo sprintf( __( 'For more details and user guides, check the plugin’s <a href="%s" target="_blank" rel="noreferrer noopener">documentation</a>.', 'gonzales' ), WbcrFactoryClearfy215_Helpers::getWebcrafticSitePageUrl( WGZ_Plugin::app()->getPluginName(), 'docs' ) ) ?>
        </p>
    </div>
    <a class="wbcr-gnz-button__pro" href="<?php echo WbcrFactoryClearfy215_Helpers::getWebcrafticSitePageUrl( WGZ_Plugin::app()->getPluginName(), 'assets-manager' ) ?>" target="_blank" rel="noreferrer noopener">'
