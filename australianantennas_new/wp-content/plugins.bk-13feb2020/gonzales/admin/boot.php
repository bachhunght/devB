...
if ( defined( 'LOADING_ASSETS_MANAGER_AS_ADDON' ) ) {
	...
	function wbcr_gnz_set_plugin_meta( $links, $file ) {
		if ( $file == WGZ_PLUGIN_BASE ) {
			$url     = WbcrFactoryClearfy215_Helpers::getWebcrafticSitePageUrl( WGZ_Plugin::app()->getPluginName(), 'assets-manager', 'plugin_row' );
	...
	add_filter( 'wbcr_factory_pages_423_imppage_rating_widget_url', 'wbcr_gnz_rating_widget_url', 10, 2 );
}