...
class WGZ_Views {
	 ...
	 * @param WBCR\Factory_Templates_106\Pages\PageBase $page
	 *
	 * @return bool|string       The page contents. False if the template doesn't exist.
	 */
	public function get_template( $template, $data = [], WBCR\Factory_Templates_106\Pages\PageBase $page = null ) {
	 ...
	 * @param WBCR\Factory_Templates_106\Pages\PageBase $page
	 */
	public function print_template( $template, $data = [], WBCR\Factory_Templates_106\Pages\PageBase $page = null ) {
