...
jQuery(document).ready(function( $ ){
	...
	//Init vars
	var ajaxRequestUrl 		= AvenZozoItemRatingsVars.ajaxUrl;
	var nonceValue			= AvenZozoItemRatingsVars.ajaxNonce;
	var rateUpdateAction	= AvenZozoItemRatingsVars.rateUpdateAction;
	var pluginConfigOptions	= AvenZozoItemRatingsVars.pluginConfigOptions;
	var ajaxUpdateErrorText	= AvenZozoItemRatingsVars.ajaxRateUpdateErrorText;
