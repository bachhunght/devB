...
add_action( 'tgmpa_register', 'aven_zozo_register_required_plugins' );
 ...
 */
function aven_zozo_register_required_plugins() {
    ...
    $plugins = array(
		...
		array(
			...
			'source'   				=> 'http://themes.zozothemes.com/extras/plugins/aven/zozothemes-core.zip', // The plugin source
		...
		array(
            ...
            'required'           	=> true, // If false, the plugin is only 'recommended' instead of required.
            'version'            	=> '6.8.0', // E.g. 1.0.0. If set, the active plugin must be this version or higher.
            'force_activation'   	=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
            'force_deactivation' 	=> false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
            'external_url'       	=> '', // If set, overrides default API URL and points to an external URL.
	 ...
	 */
    $config = array(
		'id'           => 'aven',                 // Unique ID for hashing notices for multiple instances of TGMPA.
