...
$original_layout = '';
$original_layout = aven_zozo_get_theme_option( 'zozo_archive_blog_type' );
$grid_columns = aven_zozo_get_theme_option( 'zozo_archive_blog_grid_columns' );
...
elseif( $original_layout == 'metro' ) {
	$container_class = 'zozo-isotope-layout ';
	$metro_columns = aven_zozo_get_theme_option( 'zozo_archive_blog_metro_columns' );
	$metro_gutter = aven_zozo_get_theme_option( 'zozo_archive_metro_gutter' );
...
if( aven_zozo_get_theme_option( 'zozo_disable_blog_pagination' ) ) {
			...
			<div class="zozo-row row">	
				<div id="primary" class="content-area <?php aven_zozo_primary_content_classes(); ?>">
					<div id="content" class="site-content">
						...
						if( aven_zozo_get_theme_option( 'zozo_show_archive_featured_slider' ) == 1 && aven_zozo_get_theme_option( 'zozo_featured_slider_type' ) == 'above_content' ) {
