							...
							<div id="services-content-wrap" class="services-single clearfix">										
								<div <?php post_class(); ?> id="services-<?php the_ID(); ?>">
									<?php if( $zozo_services_gallery != '' ) {
										...
										$gallery_attr = '';
										if( aven_zozo_get_theme_option( 'zozo_service_citems' ) != '' ) {
											$gallery_attr .= ' data-items=' . aven_zozo_get_theme_option( 'zozo_service_citems' ) . ' ';
										}
										
										if( aven_zozo_get_theme_option( 'zozo_service_citems_scroll' ) != '' ) {
											$gallery_attr .= ' data-slideby=' . aven_zozo_get_theme_option( 'zozo_service_citems_scroll' ) . ' ';
										}
										
										if( aven_zozo_get_theme_option( 'zozo_service_ctablet' ) != '' ) {
											$gallery_attr .= ' data-items-tablet=' . aven_zozo_get_theme_option( 'zozo_service_ctablet' ) . ' ';
										}
										
										if( aven_zozo_get_theme_option( 'zozo_service_cmobile_land' ) != '' ) {
											$gallery_attr .= ' data-items-mobile-landscape=' . aven_zozo_get_theme_option( 'zozo_service_cmobile_land' ) . ' ';
										}
										
										if( aven_zozo_get_theme_option( 'zozo_service_cmobile' ) != '' ) {
											$gallery_attr .= ' data-items-mobile-portrait=' . aven_zozo_get_theme_option( 'zozo_service_cmobile' ) . ' ';
										}
										
										if( aven_zozo_get_theme_option( 'zozo_service_cautoplay' ) == 1 ) {
											$gallery_attr .= ' data-autoplay=true ';
										} else {
											$gallery_attr .= ' data-autoplay=false ';
										}
										
										if( aven_zozo_get_theme_option( 'zozo_service_ctimeout' ) != '' ) {
											$gallery_attr .= ' data-autoplay-timeout=' . aven_zozo_get_theme_option( 'zozo_service_ctimeout' ) . ' ';
										}
										
										if( aven_zozo_get_theme_option( 'zozo_service_cloop' ) == 1 ) {
											$gallery_attr .= ' data-loop=true ';
										} else {
											$gallery_attr .= ' data-loop=false ';
										}
										
										if( aven_zozo_get_theme_option( 'zozo_service_cmargin' ) != '' ) {
											$gallery_attr .= ' data-margin=' . aven_zozo_get_theme_option( 'zozo_service_cmargin' ) . ' ';
										}
										
										if( aven_zozo_get_theme_option( 'zozo_service_cpagination' ) == 1 ) {
											$gallery_attr .= ' data-pagination=true ';
										} else {
											$gallery_attr .= ' data-pagination=false ';
										}
										
										if( aven_zozo_get_theme_option( 'zozo_service_cnavigation' ) == 1 ) {
