	...
	<div id="main-wrapper" class="zozo-row row">
		<div id="single-sidebar-container" class="single-sidebar-container <?php aven_zozo_content_sidebar_classes(); ?>">
			<div class="zozo-row row">	
				<div id="primary" class="content-area epl-archive-default <?php aven_zozo_primary_content_classes(); ?>">
						...
						<?php else : ?>
							<div class="zozo-epl-listings-wrapper">
								...
								<div class="entry-content clearfix">
									<p><?php esc_html_e('Listing not found, expand your search criteria and try again.', 'aven'); ?></p>
								</div>
							</div>
						<?php endif; ?>
