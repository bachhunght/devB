						...
						<div id="post-404" class="post post-404">
							<div class="entry-content">
								<div class="content-404page">
									<h2 class="title-one"><?php esc_html_e('Oops! Page Not Found', 'aven'); ?> </h2>
									<img src="<?php echo ZOZOTHEME_URL . '/images/404.png'; ?>" alt="404" class="img-responsive" />
									<h5 class="title-three"><?php esc_html_e( 'Sorry!! The page you are looking for does not exist.', 'aven' ); ?></h5>
