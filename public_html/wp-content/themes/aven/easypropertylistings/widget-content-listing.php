...
<div id="post-<?php the_ID(); ?>" class="epl-widget epl-listing-widget property-widget-image <?php do_action('epl_property_widget_status_class'); ?>">
	...
	<div class="entry-content">
		...
		<?php // Icon Options
		if ( $icons == 'all' ) { ?>
			<div class="property-meta property-feature-icons"><?php do_action('aven_zozo_epl_loop_property_icons'); ?></div>
		<?php } elseif ($icons == 'bb') { ?>
			<div class="property-meta property-feature-icons"><?php do_action('aven_zozo_epl_get_property_bb_icons'); ?></div>
		<?php } ?>
