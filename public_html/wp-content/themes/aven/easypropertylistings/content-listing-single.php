	...
	<div class="entry-content epl-content epl-clearfix">
		...
		<div class="epl-property-wrapper epl-clearfix">
				...
				if( ( $attachments && $attachments_count > 1 ) && $d_gallery == 1 ) { ?>
					<div class="epl-gallery property-gallery">
						<div class="epl-gallery-entry zozo-owl-carousel epl-gallery-carousel epl-clearfix" data-items="1" data-slideby="1" data-items-tablet="1" data-items-mobile-landscape="1" data-items-mobile-portrait="1" data-autoplay="true" data-autoplay-timeout="5000" data-loop="false" data-pagination="true" data-navigation="false">
							<?php aven_get_gallery_post_images( 'aven-portfolio-large', get_the_ID() ); ?>
						</div>
					</div>
					<?php
				} else { 
					do_action( 'epl_property_featured_image', 'aven-portfolio-large' );
				} ?>
			</div>
			<div class="col-md-4 col-xs-12 property-details-wrapper">
				...
				<div class="property-feature-icons epl-clearfix">
					<?php do_action('aven_zozo_epl_property_icons'); ?>				
				</div>
				...
				<div class="zozo-epl-button-wrapper epl-clearfix">
					<div class="share-icon">
						<h6 class="share-btn zozo-epl-button"><i class="fa fa-share-alt"></i><?php _e('Share', 'aven'); ?></h6>
						<div class="epl-share-icons-wrapper">
							<?php aven_zozo_display_social_sharing_icons(); ?>
						</div>
					</div>
					<div class="printer-icon">
						<h6><a href="javascript:window.print()" class="zozo-epl-button"><i class="fa fa-print"></i><?php _e('Print', 'aven'); ?></a></h6>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="tab-wrapper">
			<div class="epl-tab-section epl-section-property-details">
				<h5 class="tab-title"><?php echo apply_filters('property_tab_title', esc_html__('Property Details', 'aven')); ?></h5>
							...
							<ul class="property-details">
								...
								<li class="property-details-item">
									<p class="tab-property-id">
										<span class="property-label"><?php _e('Property ID:', 'aven'); ?></span>
								...
								<li class="property-details-item">
									<p class="tab-property-builtin">
										<span class="property-label"><?php _e('Built In:', 'aven'); ?></span>
								...
								<li class="property-details-item">
									<p class="tab-property-status">
										<span class="property-label"><?php _e('Status:', 'aven'); ?></span>
								...
								<li class="property-details-item">
									<p class="tab-address">
										<span class="property-label"><?php _e('Address:', 'aven'); ?></span>
								...
								<li class="property-details-item">
									<p class="tab-suburb">
										<span class="property-label"><?php _e('Suburb:', 'aven'); ?></span>
								...
								<li class="property-details-item">
									<p class="tab-suburb">
										<span class="property-label"><?php _e('City:', 'aven'); ?></span>
								...
								<li class="property-details-item">
									<p class="tab-state">
										<span class="property-label"><?php _e('State:', 'aven'); ?></span>
								...
								<li class="property-details-item">
									<p class="tab-pcode">
										<span class="property-label"><?php _e('Zipcode:', 'aven'); ?></span>
								...
								<li class="property-details-item">
									<p class="tab-country">
										<span class="property-label"><?php _e('Country:', 'aven'); ?></span>
							...
							<ul class="property-details">
								...
								<li class="property-details-item">
									<p class="tab-property-dateavailable">
										<span class="property-label"><?php _e('Available from:', 'aven'); ?></span>
								...
								<li class="property-details-item">
									<p class="tab-property-landarea">
										<span class="property-label"><?php esc_html_e('Land Area:', 'aven'); ?></span>
								...
								<li class="property-details-item">
									<p class="tab-property-floorarea">
										<span class="property-label"><?php esc_html_e('Floor Area:', 'aven'); ?></span>
								...
								<li class="property-details-item">
									<p class="tab-property-aircool">
										<span class="property-label"><?php esc_html_e('Air Conditioning:', 'aven'); ?></span>
										<span class="item-aircool"><?php esc_html_e('Yes', 'aven'); ?></span>
									</p>
								</li>
								<?php } ?>
								...
								<li class="property-details-item">
									<p class="tab-property-pool">
										<span class="property-label"><?php esc_html_e('Pool:', 'aven'); ?></span>
										<span class="item-pool"><?php esc_html_e('Yes', 'aven'); ?></span>
									</p>
								</li>
								<?php } ?>
								...
								<li class="property-details-item">
									<p class="tab-property-alarm">
										<span class="property-label"><?php esc_html_e('Alarm System:', 'aven'); ?></span>
										<span class="item-alarm"><?php esc_html_e('Yes', 'aven'); ?></span>
									</p>
								</li>
								<?php } ?>
								...
								<li class="property-details-item">
									<p class="tab-carport">
										<span class="property-label"><?php esc_html_e('Carport:', 'aven'); ?></span>
								...
								<li class="property-details-item">
									<p class="tab-garage">
										<span class="property-label"><?php esc_html_e('Garage:', 'aven'); ?></span>
			...
			<div class="epl-tab-section epl-section-description">
				<h5 class="tab-title"><?php echo apply_filters('epl_property_tab_title_description', esc_html__('Description', 'aven')); ?></h5>
				<div class="tab-content">
					<?php
			...
			if( $property_features_list != '' ) { ?>
				<div class="epl-tab-section epl-tab-section-features-list">
					<h5 class="tab-title"><?php echo apply_filters('epl_property_tab_title_features', esc_html__('Features', 'aven')); ?></h5>
					<div class="tab-content">
			...
			<div class="epl-tab-section epl-tab-section-features">
				<?php do_action('aven_zozo_epl_property_tab_section'); ?>
			</div>
			<?php do_action('epl_property_tab_section_after'); ?>
			
			<?php do_action( 'aven_zozo_epl_property_video' ); ?>
			...
			if( isset( $single_buttons ) && $single_buttons != '' ) { ?>
				<div class="epl-tab-section epl-tab-button-wrapper">
					<h5 class="tab-title"><?php echo apply_filters('epl_property_tab_title_buttons', esc_html__('Property Attachments', 'aven')); ?></h5>
					<div class="tab-content">
		...
		<div class="entry-footer epl-clearfix">
			<div class="entry-meta">
				<?php wp_link_pages( array( 'before' => '<div class="entry-utility entry-pages">' . esc_html__( 'Pages:', 'aven' ) . '', 'after' => '</div>', 'next_or_number' => 'number' ) ); ?>		
			</div>
		</div>
