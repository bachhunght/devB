...
if ( ! function_exists( 'aven_zozo_vc_contact_info_shortcode' ) ) {
	function aven_zozo_vc_contact_info_shortcode( $atts, $content = NULL ) {
...
if ( ! function_exists( 'aven_zozo_vc_contact_info_shortcode_map' ) ) {
	function aven_zozo_vc_contact_info_shortcode_map() {
		
		vc_map( 
			array(
				"name"					=> esc_html__( "Contact Info", "aven" ),
				"description"			=> esc_html__( "Contact info with more options.", 'aven' ),
				...
				"params"				=> array(					
					...
					array(
						...
						"value"			=> array(
							esc_html__( "Default", "aven" )	=> "default",
							esc_html__( "Style 2", "aven" )	=> "style2",
						),
					),
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Widget Title", "aven" ),
						"param_name"	=> "widget_title",
						"value"			=> "",
					),
					array(
						"type"			=> "textarea",
						"heading"		=> esc_html__( "Description", "aven" ),
					...
					array(
						...
						"description" 	=> esc_html__( "Choose this option to show border separator between widget description and contact info.", "aven" ),
					),
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Address Label", "aven" ),
					...
					array(
						"type"			=> "textarea_html",
						"holder"		=> "div",
						"heading"		=> esc_html__( "Address", "aven" ),
						"param_name"	=> "content",
						"value"			=> esc_html__( 'I am text block. Please change this dummy text in your page editor for this box.', "aven" ),
					),
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Phone Label", "aven" ),
						"param_name"	=> "phone_label",
						"value"			=> "",
					),
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Phone Number", "aven" ),
						"param_name"	=> "phone_number",
						"value"			=> "",
					),
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Phone Number 2", "aven" ),
						"param_name"	=> "phone_number2",
						"value"			=> "",
					),
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Phone Number 3", "aven" ),
						"param_name"	=> "phone_number3",
						"value"			=> "",
					),
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Email Label", "aven" ),
						"param_name"	=> "email_label",
						"value"			=> "",
					),
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Email Address", "aven" ),
						"param_name"	=> "email_address",
						"value"			=> "",
					),
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Email Address 2", "aven" ),
						"param_name"	=> "email_address2",
						"value"			=> "",
					),
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Email Address 3", "aven" ),
						"param_name"	=> "email_address3",
						"value"			=> "",
					),
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Social Label", "aven" ),
						"param_name"	=> "social_label",
						"value"			=> "",
						"group"			=> esc_html__( "Social Icons", "aven" ),
					),
					array(
						"type"			=> 'dropdown',
						'admin_label' 	=> true,
						"heading"		=> esc_html__( "Type", "aven" ),
					...
					array(
						...
						"value"			=> array(
							...
							esc_html__( "Background", "aven" )	=> "background",
						),
						'dependency'	=> array(
					...
					array(
						"type"			=> "vc_link",
						"heading"		=> esc_html__( "Facebook Link", 'aven' ),
						"param_name"	=> "facebook",
						"value"			=> "",
						"group"			=> esc_html__( "Social Icons", "aven" ),
					),
					array(
						"type"			=> "vc_link",
						"heading"		=> esc_html__( "Twitter Link", 'aven' ),
						"param_name"	=> "twitter",
						"value"			=> "",
						"group"			=> esc_html__( "Social Icons", "aven" ),
					),
					array(
						"type"			=> "vc_link",
						"heading"		=> esc_html__( "Pinterest Link", 'aven' ),
					...
					array(
						"type"			=> "vc_link",
						"heading"		=> esc_html__( "Linkedin Link", 'aven' ),
						"param_name"	=> "linkedin",
						"value"			=> "",
						"group"			=> esc_html__( "Social Icons", "aven" ),
					),
					array(
						"type"			=> "vc_link",
						"heading"		=> esc_html__( "Youtube Link", 'aven' ),
						"param_name"	=> "youtube",
						"value"			=> "",
						"group"			=> esc_html__( "Social Icons", "aven" ),
					),
					array(
						"type"			=> "vc_link",
						"heading"		=> esc_html__( "RSS Link", 'aven' ),
						"param_name"	=> "rss",
						"value"			=> "",
						"group"			=> esc_html__( "Social Icons", "aven" ),
					),
					array(
						"type"			=> "vc_link",
						"heading"		=> esc_html__( "Tumblr Link", 'aven' ),
						"param_name"	=> "tumblr",
						"value"			=> "",
						"group"			=> esc_html__( "Social Icons", "aven" ),
					),
					array(
						"type"			=> "vc_link",
						"heading"		=> esc_html__( "Reddit Link", 'aven' ),
						"param_name"	=> "reddit",
						"value"			=> "",
						"group"			=> esc_html__( "Social Icons", "aven" ),
					),
					array(
						"type"			=> "vc_link",
						"heading"		=> esc_html__( "Dribbble Link", 'aven' ),
						"param_name"	=> "dribbble",
						"value"			=> "",
						"group"			=> esc_html__( "Social Icons", "aven" ),
					),
					array(
						"type"			=> "vc_link",
						"heading"		=> esc_html__( "Flickr Link", 'aven' ),
						"param_name"	=> "flickr",
						"value"			=> "",
						"group"			=> esc_html__( "Social Icons", "aven" ),
					),
					array(
						"type"			=> "vc_link",
						"heading"		=> esc_html__( "Instagram Link", 'aven' ),
					...
					array(
						"type"			=> "vc_link",
						"heading"		=> esc_html__( "Vimeo Link", 'aven' ),
						"param_name"	=> "vimeo",
						"value"			=> "",
						"group"			=> esc_html__( "Social Icons", "aven" ),
					),
					array(
						"type"			=> "vc_link",
						"heading"		=> esc_html__( "Skype Link", 'aven' ),
						"param_name"	=> "skype",
						"value"			=> "",
						"group"			=> esc_html__( "Social Icons", "aven" ),
					),
					array(
						"type"			=> "vc_link",
						"heading"		=> esc_html__( "Blogger Link", 'aven' ),
						"param_name"	=> "blogger",
						"value"			=> "",
						"group"			=> esc_html__( "Social Icons", "aven" ),
					),
					array(
						"type"			=> "vc_link",
						"heading"		=> esc_html__( "Yahoo Link", 'aven' ),
						"param_name"	=> "yahoo",
						"value"			=> "",
						"group"			=> esc_html__( "Social Icons", "aven" ),
					),
					...
					array(
						"type"			=> "colorpicker",
						"heading"		=> esc_html__( "Widget Title Color", "aven" ),
						"param_name"	=> "title_color",
						"group"			=> esc_html__( "Stylings", "aven" ),
					),
					array(
						"type"			=> "colorpicker",
						"heading"		=> esc_html__( "Widget Description Color", "aven" ),
					...
					array(
						"type"			=> "colorpicker",
						"heading"		=> esc_html__( "Address Label Color", "aven" ),
						"param_name"	=> "address_label_color",
						"group"			=> esc_html__( "Stylings", "aven" ),
					),
					array(
						"type"			=> "colorpicker",
						"heading"		=> esc_html__( "Address Text Color", "aven" ),
						"param_name"	=> "address_color",
						"group"			=> esc_html__( "Stylings", "aven" ),
					),
					array(
						"type"			=> "colorpicker",
						"heading"		=> esc_html__( "Phone Label Color", "aven" ),
						"param_name"	=> "phone_label_color",
						"group"			=> esc_html__( "Stylings", "aven" ),
					),
					array(
						"type"			=> "colorpicker",
						"heading"		=> esc_html__( "Phone Text Color", "aven" ),
						"param_name"	=> "phone_color",
						"group"			=> esc_html__( "Stylings", "aven" ),
					),
					array(
						"type"			=> "colorpicker",
						"heading"		=> esc_html__( "Email Label Color", "aven" ),
						"param_name"	=> "email_label_color",
						"group"			=> esc_html__( "Stylings", "aven" ),
					),
					array(
						"type"			=> "colorpicker",
						"heading"		=> esc_html__( "Email Text Color", "aven" ),
						"param_name"	=> "email_color",
						"group"			=> esc_html__( "Stylings", "aven" ),
					),
					array(
						"type"			=> "colorpicker",
						"heading"		=> esc_html__( "Social Label Color", "aven" ),
					...
					array(
						"type"			=> "colorpicker",
						"heading"		=> esc_html__( "Icon Background Hover Color", "aven" ),
					...
					array(
						"type"			=> "colorpicker",
						"heading"		=> esc_html__( "Icon Border Hover Color", "aven" ),
...
add_action( 'vc_before_init', 'aven_zozo_vc_contact_info_shortcode_map' );