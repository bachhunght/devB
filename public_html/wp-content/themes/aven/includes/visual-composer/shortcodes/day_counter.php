...
if ( ! function_exists( 'aven_zozo_vc_day_counter_shortcode' ) ) {
	function aven_zozo_vc_day_counter_shortcode( $atts, $content = NULL ) {
...
if ( ! function_exists( 'aven_zozo_vc_day_counter_shortcode_map' ) ) {
	function aven_zozo_vc_day_counter_shortcode_map() {
		
		vc_map( 
			array(
				"name"					=> esc_html__( "Day Counter", "aven" ),
				"description"			=> esc_html__( "Animated Day Up/Down Counter.", 'aven' ),
				...
				"params"				=> array(					
					...
					array(
						"type"			=> 'dropdown',
						"heading"		=> esc_html__( "Counter Type", "aven" ),
						"param_name"	=> "counter_type",
						"admin_label" 	=> true,
						"value"			=> array(
							esc_html__( "Counter Down", "aven" )		=> "down",
							esc_html__( "Counter Up", "aven" )		=> "up" ),
					),
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Year", "aven" ),
						"admin_label" 	=> true,
						"param_name"	=> "year",						
					),
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Month", "aven" ),
						"admin_label" 	=> true,
						"param_name"	=> "month",						
					),
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Date", "aven" ),
						"admin_label" 	=> true,
						"param_name"	=> "date",
					),
					array(
					...
					array(
						"type"			=> "vc_link",
						"heading"		=> esc_html__( "Button Link", "aven" ),
...
add_action( 'vc_before_init', 'aven_zozo_vc_day_counter_shortcode_map' );