...
// Custom CSS
if( aven_zozo_get_theme_option( 'zozo_custom_css' ) != '' ) {
	echo aven_zozo_get_theme_option( 'zozo_custom_css' );
}
...
$body_bg_img_opt = aven_zozo_get_theme_option( 'zozo_body_bg_image' );
...
if( isset( $body_bg_opacity ) && $body_bg_opacity != 0 ) {
	$body_rgb_color = '';
	$body_rgb_color = aven_zozo_hex2rgb( $body_bg_color );
}
...
$header_bg_img_opt = aven_zozo_get_theme_option( 'zozo_header_bg_image' );
...
if( isset( $header_bg_opacity ) && $header_bg_opacity != 0 ) {
	$header_rgb_color = '';
	$header_rgb_color = aven_zozo_hex2rgb( $header_bg_color );
}
...
$page_bg_img_opt = aven_zozo_get_theme_option( 'zozo_page_bg_image' );
...
if( isset( $page_bg_opacity ) && $page_bg_opacity != 0 ) {
	$page_rgb_color = '';
	$page_rgb_color = aven_zozo_hex2rgb( $page_bg_color );
}
...
if( isset( $theme_layout ) && $theme_layout == '' ) {
	$theme_layout = aven_zozo_get_theme_option( 'zozo_theme_layout' );
}
...
$header_side_width_opt = aven_zozo_get_theme_option( 'zozo_header_side_width' );
