...
<?php $current_options = wp_parse_args( get_option( 'soon_page_settings', array() ), $general_default_settings );
	...
	<form method="post" action="#section_general">
        ...
        <div class="section">
            <div class="element">
            	<h3><?php _e('Google Plus URL','easy-coming-soon') ?></h3>
                <input type="text" id="gp" name="gp" placeholder="<?php _e('Google Plus URL','easy-coming-soon') ?>"  value="<?php if(!empty($current_options['gp'])){ echo $current_options['gp']; } ?>"/>
            </div>
        </div>
