							...
							<form method="post" id="easy-coming-soon_lite_theme_options_5">
									<div id="heading">
										<table style="width:100%;"><tr>
											...
											<br>
											<p><?php echo sprintf (__("In this
											<a target = '_blank' href = 'https://www.youtube.com/watch?v=jwXOO9DDSpY'>Video Tutorial</a>, I will demonstrate how you can create a fully functional Coming Soon Page in as little as 30 minutes.","easy-coming-soon")); ?></p>
											...
											</p><?php echo sprintf(__("The premium version is priced at 29 USD and lets you use the plugin on unlimited website.</p>
											<p>Here is the <a target = '_blank' href = 'https://youtu.be/JEbKUdvbzys'> link to the Video.</a> Enjoy!!!","easy-coming-soon")); ?></p>
											</td>
											<td style="width:30%;">
											</td>
											<td style="text-align:right;">					
